		...
		return (
			<ul className="text-sm ml-4">
				{links.map((link, index) => (
					<li key={index}>
						<MdArrowForward className="inline-block align-middle" />{" "}
						{/* Arrow icon */}
						<a href={link.url} className="ml-2 hover:text-blue-500">
							{link.title}
						</a>{" "}
						{/* Added hover effect */}
					</li>
		...
		<footer className="relative bg-gray-600 text-white py-8 mt-5 lg:p-10">
			<div className="container mx-auto relative">
					...
					<div className="w-full md:w-1/3 p-2">
						...
						<div className="bg-transparent rounded-lg overflow-hidden">
							...
							<div className="mt-4">
								...
								<span className="ml-8 block">
									REVENUE SURVEY NO. 727/1 and 727/2 Village Menpura, Taluka
									Dabhoi Dist, Vadodara Gujarat, India
								</span>
							</div>
						</div>
					</div>
				...
				<div className="text-sm text-center">
					<p>
						Copyright © 2024 Polyplast, All Rights Reserved. | Developed by
						<a
