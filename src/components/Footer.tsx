    ...
    <footer className="bg-gray-900 text-white py-8 relative">
      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 p-4">
            <div className="bg-transparent rounded-lg overflow-hidden">
              <h3 className="text-lg font-semibold mb-2">Rolan Plast Chemi Plants (I) Pvt Ltd</h3>
              <div className="mb-2">
                <div className="flex items-center">
                  <img
                ...
                <span className="ml-8 block">
                  Thakore Industrial Estate, Kurla-Kirol Road, Vidyavihar (West),<br />
              ...
              <div className="mt-4">
                ...
                <span className="ml-8 block">
                  REVENUE SURVEY NO. 727/1 and 727/2 Village Menpura,<br />
