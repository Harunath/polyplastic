        ...
        <div className="row">
          <div className="col-md-12">
            <p className="txt-justify  mb-4">
              'Rolan Plast' plays a part and cooperates in your project execution during the journey, ensuring that your project is managed pleasantly & accurately.
            </p>
            <p className="txt-justify  mb-2">Our project management mixture includes:</p>
            <ul className="mt-2 pl-5 list-none">
              <li className="mb-2 relative flex items-center">
                <span style={{width: "0", height: "0", borderTop: "6px solid transparent", borderBottom: "6px solid transparent", borderRight: "6px solid red", marginRight: "0.5rem"}}></span>
                Discuss & developing an overall project execution plan and workflow with customer requirement.
              </li>
            </ul>
            <ul className={`pl-5 list-none ${expanded ? '' : 'hidden'}`}>
              <li className="mb-2 relative flex items-center">
                <span style={{width: "0", height: "0", borderTop: "6px solid transparent", borderBottom: "6px solid transparent", borderRight: "6px solid red", marginRight: "0.5rem"}}></span>
            ...
            <div className="pb-4">
              <u>
                <a onClick={toggleExpanded} className="moreless-button text-dark fw-bold cursor-pointer">
