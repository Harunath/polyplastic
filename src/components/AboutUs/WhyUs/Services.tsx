      ...
      <div className="flex flex-wrap justify-center">
        {servicesData.map((service) => (
          <div key={service.id} className="max-w-xs w-32 h-32 mx-2 my-4 pb-2 bg-white rounded-lg overflow-hidden shadow-md text-center relative">
            <div className="w-16 h-16 mx-auto my-4 rounded-full border-4 border-gray-300 flex items-center justify-center overflow-hidden transition duration-300 ease-in-out transform hover:border-red-500">
